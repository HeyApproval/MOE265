...
lib.ssMetadata = [
		{name:"MOE265_Display_Prepare_1T_300x250_atlas_P_1", frames: [[0,0,1250,1043]]}
];
...
(lib.BkgdPrepare_300x250_DisplayPrepare = function() {
	this.initialize(ss["MOE265_Display_Prepare_1T_300x250_atlas_P_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.MOE265_Display_Prepare_1T_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/MOE265_Display_Prepare_1T_300x250_atlas_P_1.png?1623179632249", id:"MOE265_Display_Prepare_1T_300x250_atlas_P_1"}
	],
	preloads: []
};
